...
const DataKanban = ({
    ...
    const onDragEnd = useCallback((result: DropResult) => {
        ...
        setTasks((prevTasks) => {
            ...
            // if theres no moved task { shouldn't happen, but in case } return prevTasks
            if (!movedTask) {
            ...
            // safely add task to destination column
            const destColumn = [...newTasks[destStatus]];
            destColumn.splice(destination.index, 0, updatedMovedTask);

            newTasks[destStatus] = destColumn;

        //  preapre minimal update payload
            updatesPayload = [];
            ...
            //  update position for affected  tasks in the source column
