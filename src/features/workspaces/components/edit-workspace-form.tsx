...
export const EditWorkspaceForm = ({ onCancel, initialValues }: EditWorkspaceFormProps) => {
    ...
    const [ResetDialog, confirmReset] = useConfirm(
        "Reset Invite Code",
        "This will invalidate all existing invite codes.",
        "destructive"
    );
            ...
            <Card className="w-full h-full border-none shadow-none">
                <CardContent className="p-7">
                    <div className="flex flex-col">
                        ...
                        <p className="text-sm text-muted-foreground">
                            Use the invite link to invite new members to your workspace.
                        </p>
                        <div className="mt-4">
                            <div className="flex items-center gap-x-2">
                                <input className="w-full" type="text" disabled value={fullInviteLink} />
                                <Button
            ...
            <Card className="w-full h-full border-none shadow-none">
                <CardContent className="p-7">
                    <div className="flex flex-col">
                        ...
                        <p className="text-sm text-muted-foreground">
                            Deleting a workspace will permanently delete all projects and tasks associated with it.
                        </p>
                        <DottedSeparator className="py-7" />
                        <Button
                            type="button"
